...
import hook from "./useModalState";

export const useModalState = hook;
 ...
 * The best solution is to use a props buffer: save the props somewhere (maybe another state or a `Ref`) and pass _those_ saved props.
 *
 * @param {Object} props
