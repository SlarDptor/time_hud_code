...
export const TYPES = mapValues({ 
  ...
  SET_INTERFACE: 0, SET_ALTERNATE_DAY: 0, SET_PERIOD_TYPE: 0, ADD_MINUTES: 0, TAKE_MINUTES: 0 //Parameterized Actions
...
const ACTION_CREATORS = {
  ...
  setPeriodType: (newPeriodType) => ({
    type: TYPES.SET_PERIOD_TYPE,
    params: { newPeriodType },
  }),
  addMinutes: (minutes) => ({
 ...
 * @property {(newPeriodType) => any} setPeriodType Sets all alternate days setting.
